...
<div class="max-w-6xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            ...
            @endif
            <a href="{{ Auth::user()->isAdmin() ? route('admin.pets') : (Auth::user()->isDoctor() ? route('doctor.pets') : route('pet-owner.pets')) }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400">
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="bg-[#1e3a5f] px-6 py-4 flex justify-between items-center">
            ...
            <a href="{{ route('medical-records.create', ['pet_id' => $pet->id]) }}" 
               class="px-4 py-2 bg-[#28a745] text-white rounded-lg hover:bg-[#218838] transition">
        ...
        <div class="p-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-600 text-lg mb-4">No medical records yet</p>
                    @if(Auth::user()->isDoctor())
                    <a href="{{ route('medical-records.create', ['pet_id' => $pet->id]) }}" 
                       class="inline-flex items-center px-4 py-2 bg-[#0d5cb6] text-white rounded-lg hover:bg-[#003d82] transition">
                        <i class="fas fa-plus mr-2"></i>Create First Medical Record
                    </a>
                    @else
                    <p class="text-gray-500 text-sm">Medical records will appear here once created by doctors</p>
                    @endif
                </div>
            @endif
        </div>
